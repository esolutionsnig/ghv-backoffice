...
export default {
  methods: {
    ...
    generatePdf() {
      ...
      doc.save("quoteRequest.pdf");
    },

    // Mark Item as Processed
    markAsProcessed() {
      this.selected.forEach(value => {
        db.collection("quoteRequest")
          .doc(value)
          .update({
          ...
          .then(result => {
            this.res = result;
            this.snackbar = true;
            this.msg = "Quote request successfully marked as processed.";
      ...
      this.selected.forEach(value => {
        db.collection("quoteRequest")
          ...
          .then(result => {
            this.res = result;
            this.snackbar = true;
            this.msg = "Quote request successfully marked as unprocessed.";
            this.msgTimeout = 6500;
            this.msgIcon = "thumb_up";
            this.msgColor = "success";
          })
